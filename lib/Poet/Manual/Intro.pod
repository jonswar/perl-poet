...
Mason is a very full-featured templating system and we won't even attempt to
summarize it here.  Recommended reading:
...
If any other kind of runtime error occurs in development mode, it will be
displayed via L<Plack::Middleware::StackTrace|Plack::Middleware::StackTrace>.

Otherwise, runtime errors are converted to 500 error responses.
