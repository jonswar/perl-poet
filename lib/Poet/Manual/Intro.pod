...
Poet makes it easy to import certain variables into any module or script in
...
You can add your own variables by L<customizing
Poet::Import|Poet::Manual::Subclassing>.
